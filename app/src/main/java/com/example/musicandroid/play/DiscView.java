...
public class DiscView extends RelativeLayout {
    ...
    private void initDiscBlackground() {
        ImageView mDiscBlackground = (ImageView) findViewById(R.id.iv_disc_background);
    ...
    private void initViewPager() {
        ...
        mVpContain = (ViewPager) findViewById(R.id.vp_disc_contain);
    ...
    public void setMusicDataList(List<MusicData> musicDataList) {
        ...
        MusicData musicData = mMusicDatas.get(1);
        if (mIPlayInfo != null) {
